...
-- Unified DDL Database Schema (MySQL 8.0+ & H2 Compatible)
-- ============================================================================
...
CREATE TABLE IF NOT EXISTS apartments (
    ...
    common_area_sqft DECIMAL(10, 2) NOT NULL DEFAULT 0.00,
...
CREATE TABLE IF NOT EXISTS tariff_plans (
    ...
    description TEXT,
    base_fixed_charge DECIMAL(10, 2) NOT NULL DEFAULT 150.00,
    sewage_maintenance_pct DECIMAL(5, 2) NOT NULL DEFAULT 10.00,
    bulk_purchase_markup_pct DECIMAL(5, 2) NOT NULL DEFAULT 5.00,
    is_active BOOLEAN NOT NULL DEFAULT TRUE,
...
CREATE TABLE IF NOT EXISTS tariff_tiers (
    ...
    min_liters DECIMAL(12, 2) NOT NULL,
    max_liters DECIMAL(12, 2),
...
CREATE TABLE IF NOT EXISTS meter_readings (
    ...
    previous_reading_liters DECIMAL(12, 2) DEFAULT 0.00,
    current_reading_liters DECIMAL(12, 2) NOT NULL,
    daily_consumption_liters DECIMAL(12, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS bulk_water_purchases (
    ...
    tanker_capacity_liters DECIMAL(12, 2) NOT NULL,
...
CREATE TABLE IF NOT EXISTS billing_cycles (
    ...
    total_metered_consumption_liters DECIMAL(14, 2) NOT NULL DEFAULT 0.00,
    total_bulk_purchased_liters DECIMAL(14, 2) NOT NULL DEFAULT 0.00,
